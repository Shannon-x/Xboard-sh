...
class PlanSave extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'prices.*' => 'nullable|numeric|decimal:0,2|min:0|max:999999.99',
            ...
            'customization' => 'nullable|array:transfer_enable,device_limit,speed_limit,addon_groups,traffic_topup',
    ...
    public function messages(): array
    {
        return [
            ...
            'prices.*.min' => '价格不能为负数',
            'prices.*.decimal' => '价格最多保留两位小数，且不允许指数形式',
            'prices.*.max' => '价格不能超过 999999.99',
