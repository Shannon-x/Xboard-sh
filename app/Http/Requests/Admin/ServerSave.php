...
class ServerSave extends FormRequest
{
    ...
    private const PROTOCOL_RULES = [
        ...
        'vless' => [
            ...
            'encryption_settings.mode' => 'nullable|string',
            'encryption_settings.rtt' => 'nullable|string',
            'encryption_settings.ticket_time' => 'nullable|string',
            'encryption_settings.server_padding' => 'nullable|string',
            'encryption_settings.private_key' => 'nullable|string',
            'encryption_settings.client_padding' => 'nullable|string',
            'encryption_settings.password' => 'nullable|string',
            'tls_settings.server_name' => 'nullable|string',
            'tls_settings.allow_insecure' => 'nullable|boolean',
